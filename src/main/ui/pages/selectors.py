...
BUILD_QUEUE_BUILD_TYPE_CELL = '[data-test="build-type-cell"], td:first-child, .buildTypeName'
BUILD_QUEUE_TIME_CELL = '[data-test="queue-time-cell"], td:last-child, .queuedTime'
BUILD_QUEUE_CANCEL_BUTTON = '[data-test="cancel-build"], button:has-text("Cancel"), .cancelBuild'
BUILD_ARTIFACT_DOWNLOAD_LINK = '[data-test="artifact-download"], a[href*="artifacts"], .artifactLink'
...
BUILD_RESULTS_STATUS_TEXT = '[data-test="build-results-status"], .buildResultsStatus, .statusText'
BUILD_STOP_BUTTON = '[data-test="stop-build"], button:has-text("Stop"), .stopBuild'
BUILD_STOP_CONFIRM_BUTTON = '[data-test="stop-confirm"], button:has-text("Stop build"), .confirmStop'
