...
class Property(BaseModel):
    ...
    type: Optional[Dict[str, str]] = Field(
        None, description="Property type (e.g., password)"
    )
...
class StartBuildRequest(BaseModel):
    ...
    properties: Optional[PropertiesContainer] = Field(
        None, description="Build parameters"
    )
