...
class TestCreateProjectPositive:
    def test_create_project_with_valid_id(self, api_manager: ApiManager):
        ...
        assert (
            create_project_request.id in project_ids
        ), f"Created project ID '{create_project_request.id}' not found in projects list"

        project_names = [project.name for project in projects]
        assert (
            create_project_request.name in project_names
...
class TestCreateProjectNegative:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                GenerateData.get_project_id_with_length(226),
                GenerateData.get_project_name(),
    ...
    def test_invalid_project_id(
        ...
        project_ids = [project.id for project in projects]
        assert (
            create_project_request.id not in project_ids
    ...
    def test_project_with_duplicate_name(
        self,
    ...
    def test_project_with_duplicate_id(
        self,
        api_manager: ApiManager,
        project_name,
        create_project: CreateProjectRequest,
